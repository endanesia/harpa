<div class="card card-body">
	...
	<form method="post" action="<?= site_url('gaji/Simpan_edit/' . $id) ?>">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<table class="table table-bordered table-sm table-striped">
					...
					<tbody>
						<?php $tot_tunj = 0; foreach ($tunjangan as $tunj) { 
								$tot_tunj = $tot_tunj + $tunj->jml;
							?>
							<tr>
					...
					<tfoot>
						<tr>
							...
							<td style="text-align:right"><?= number_format($tot_tunj, 2, ",", ".") ?></td>
						</tr>
					</tfoot>
				</table>
			</div>
			<div class="col-md-6">
				...
				<table class="table table-bordered table-sm table-striped">
					...
					<tbody>
						<?php $tot_pot = 0; foreach ($potongan as $pot) { 
								$tot_pot = $tot_pot + $pot->jml;
							?>
							<tr>
					...
					<tfoot>
						<tr>
							<td style="text-align:right"><b>Total :</b></td>
							<td style="text-align:right"><?= number_format($tot_pot, 2, ",", ".") ?></td>
						</tr>
					</tfoot>
				</table>
			</div>
		...
		<div class="row">
			<div class="col-md-4">
				<b>Gaji Diterima : </b> <br>
				<?php 
					$thp = $gaji->gaji_pokok + $tot_tunj;
					$thp = $thp - $tot_pot;
				?>
				<table class="table table-sm">
					...
					<tr>
						<td>Tunjangan</td>
						<td> : </td>
						<td><?= number_format($tot_tunj, 2, ",", ".") ?></td>
						<td></td>
						<td></td>
					</tr>
					<tr>
