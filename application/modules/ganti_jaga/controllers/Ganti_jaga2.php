...

{
...

	{
		...
		$this->load->model(array('ganti_jaga_model'));
...

	{
		...
		$pdf->Cell(52, 1, ' : ' . $dpdg->namaPegawai, 'R', 0, 'L');
		...
		$pdf->Cell(52, 1, ' : ' . $dpmg->namaPegawai, 'R', 0, 'L');
		...
		$pdf->Cell(94, 1, 'JABATAN : ' . $jab->namaJabatan, 'LR', 0, 'L');
...

	{
		...
		if(($pangkat->namaJabatan=="SATUAN PENGAMANAN")||($pangkat->namaJabatan=="CP KTH")||($pangkat->namaJabatan=="CP KTH")||($pangkat->namaJabatan=="TENAGA HELPER CCR")||($pangkat->namaJabatan=="TENAGA BANTU TEKNISI MESIN PPS"))
		...
		$pdf->Cell(94, 1, '6. PEMBERI TUGAS KERJA LEMBUR :  KPLTA/SPVS___________', 1, 0, 'L', true);
		...
		$pdf->Cell(20, 1, 'ASMAN PLTA', 'R', 0, 'C');
		...
		$pdf->Cell(94, 1, '7. PEMERIKSA HASIL KERJA LEMBUR', 1, 0, 'L', true);
		...
		$pdf->Cell(20, 1, $lembur->namaPemberiTugas, 'RB', 0, 'C');
